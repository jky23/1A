...
procedure Exemples_Memoire_Dynamique is
	...
	begin
		...
		-- XXX Quelle est la valeur de Ptr2.all ? Elle est égale à 0
		...
		-- XXX A-t-on le droit de manipuler Ptr2.all ? Non car le contenu du pointeur a été mis a null
	...
	begin
		...
		Ptr.all := 111;
		SP (Ptr);
		-- XXX Quelle est la valeur de Ptr.all ? elle devient 123
	...
	begin
		...
		-- d'appeler Detruire dessus ? -- Oui car le compilateur gnat ne fournit pas de garbage collector
