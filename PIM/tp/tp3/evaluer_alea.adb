...
procedure Evaluer_Alea is
    ...
    begin
        --definir un tableau de capacité Borne
        -- Definir un second tableau de capacité Taille
        --Remplir le second tableau en utilisant la fonction Get_Random_Number
        --Calculer la plus petite occurence et la plus grande occurence
