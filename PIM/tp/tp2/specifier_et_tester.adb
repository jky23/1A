...
procedure Specifier_Et_Tester is
    ...
    function Pgcd (A, B : in Integer) return Integer with
        ...
        Post =>  Pgcd'Result >= 1
            ...
            --Pgcd'Result désigne le résultat de l'appel de la fonction pgcd
    is
    ...
    --Non car la variable Resultat n'est pas déclarée correctement
    -- Que donne son exécution ? Son exécution entraine une erreur car la variable utilisée n'est pas définie
    ...
    procedure Permuter (A, B: in out Integer) with
            ...
            --A'old(resp.B'old) désigne la valeur initiale de A (resp.B)
    is
        Copie_A : Integer;
    begin
        Copie_A := A;
