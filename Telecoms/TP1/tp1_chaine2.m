...
% 1ere chaine
  % Mapping binaire à moyenne nulle 0-> 0, 1->1
  %Symboles_1 = 2*Bits - 1;
  
  % Suréchantillonage : generation de la suite de diracs pondérés
  Suite_diracs_1 = kron(Bits,[1, zeros(1,Ns-1)]);
  ...
  for i = 0 : 6
      ...
      TEB_Theo(i+1) = qfunc(sqrt(Eb_No)); % Mapping unipolaire; Filtrage adapté
     % Rajout du bruit
