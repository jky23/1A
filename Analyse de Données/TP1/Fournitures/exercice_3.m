...
%I = imread('gantrycrane.png'); % 2nd exemple
 I = imread('pears.png'); %3eme exemple
...
%% Affichage des combinaisons lineaires

% Image selon (1)
Invg = (1/3)*(R+V+B);

figure  %4eme fenetre d'affichage
subplot(221) 
imagesc(I)
axis off image
...
imagesc(Invg)
axis off image
title('Image selon (1)','FontSize',20)

subplot(224)
imagesc(rgb2gray(I))
axis off image
title('Image selon (2)','FontSize',20)
