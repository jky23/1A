...
public class Segment {
	...
	* @param dx déplacement suivant l'axe des Xouleur) {
	...
	*/
	...
	/** Dessiner un segment graphiquement.
	 * @param E Ecran ou dessiner
	 * @param col couleur du segment
	 */
	public void dessiner(Ecran E, Color col) {
		assert (col != null);
		assert (E != null);
		E.dessinerLigne(this.extremite1.getX(), this.extremite1.getY(), this.extremite2.getX(), this.extremite2.getY(), col);
	}
