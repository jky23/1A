...
public class GateCityWithShield extends VueTuileAbstraite {
	private static final String IMAGE_PATH = "src/resources/Gate_City_With_Shield.png";
	
	public GateCityWithShield(int row, int col) {
		super(IMAGE_PATH, row, col);
	}

	private GateCityWithShield() {}
	...
	public VueTuileAbstraite construireTuile(int row, int col) {
		return new GateCityWithShield(row, col);
	}
	
	public static CreateurTuile getConstruction() {
		return new CreateurTuile(new GateCityWithShield());
	}
}