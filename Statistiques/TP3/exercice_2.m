...
plot(theta(conformes_1),rho(conformes_1),'r+','MarkerSize',10,'LineWidth',2);
...
plot(x_F_1,y_F_1,'r*','MarkerSize',10,'LineWidth',3);
...
plot(theta(conformes_2),rho(conformes_2),'g+','MarkerSize',10,'LineWidth',2);

% Affichage du deuxieme point de fuite estime :
subplot(1,2,2);
x_F_2 = rho_F_2*cos(theta_F_2);
y_F_2 = rho_F_2*sin(theta_F_2);
plot(x_F_2,y_F_2,'g*','MarkerSize',10,'LineWidth',3);
