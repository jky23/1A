...
Axiom snoc_Cons : forall (e  : A), forall (t : A), forall (q : liste), snoc_spec e (Cons t q)  = Cons t (snoc_spec e q).

(* snoc pourrais être spécifié avec append *)
Theorem snoc_alternative : forall (e : A), forall(l : liste), snoc_spec e l = append_spec l (Cons e Nil).
Proof.
intros.
elim l.
rewrite snoc_Nil.
...
Theorem snoc_append : forall ( e: A),forall (l1 l2 : liste), snoc_spec e (append_spec l1 l2)  = append_spec l1 (snoc_spec e l2).
Proof.
intros.
elim l1.
rewrite append_Nil.
