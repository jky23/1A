%
% ~gergaud/ENS/Automatique/TP18-19/TP2/Etudiants/Ressources/test_pendule_inv_echant.m
%
...
fich_mat = ['Ressources/echant_' fich '.mat']
...
%
% Fonctions
function affichage(fich, t0, g, l, xe, ue, x0, tf, K, delta_t, options_sim);
% 
